					...
					<div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
						<div class="product-categori">
							<div class="search-product">
								<form action="#">
									<input class="form-control" placeholder="Bạn tìm gì..." type="text">
										...
										<c:forEach var="category" items="${requestScope.categories}">
											<li>
												<div class="radio radio-danger">
													<input id = "category" name="category" onclick="location.href = 'shop?category=${category.id}&sortby=${param.sortby}'" value="${category.nameOut}" ${category.id==param.category ? 'checked' : ''} type="radio">
													<label> ${category.nameOut} </label>
												</div>
											</li>
										</c:forEach>
									</ul>
									...
									<div class="toolbar-sorter-right">
										...
										<script>
											document.getElementById('sort-mode').addEventListener("change", function () {
												...
												location.href = 'shop?&sortby=' + mode + '&q=${param.q}';
											});
										</script>
									</div>
								</div>
									...
									<div role="tabpanel" class="tab-pane fade show active" id="grid-view">
										<div class="row">
											<c:forEach var="product" items="${requestScope.products}">
												<div class="col-sm-6 col-md-6 col-lg-4 col-xl-4 ${product.category}">
													<div class="products-single fix">
														<div class="box-img-hover">
															...
															<div class="mask-icon">
																...
																<a class="cart" href="add?product_id=${product.id}&quantity=1&goto=shop"> Thêm vào giỏ hàng </a>
															</div>
														</div>
														<div class="why-text">
										...
										<c:forEach var="page" items="${pages}">
											<li class="page-item">
												<a class="page-link page"
												   href="shop?category=${param.category}&sortby=${param.sortby}&page=${page}">${page}</a>
											</li>
										</c:forEach>
									</ul>
								</nav>
